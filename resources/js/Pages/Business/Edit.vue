...
const category_ids = usePage().props.category_ids;
...
const submit = () => {
    form.put(route('businesses.update', business.id), {
        preserveScroll: true,
    });
};
</script>
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Update Business</h2>
        </template>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                >
                                    <option
                                        ...
                                        :key="item.id"
                                        :value="item.id"
                                        :selected="category_ids.includes(item.id)"
                                    >
                                        {{ item.name }}
                                    </option>
                                </select>
